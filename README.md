...
The primary objective of this project is to learn to employ various stateful widgets and state-management techniques to implement a non-trivial, single-page application using Flutter. 
